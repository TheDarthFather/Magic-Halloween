...
1. Use directly the [merged pack](https://download.mc-packs.net/pack/f763c9554490a2f779abd6697a4b20668f7463db.zip) between Magic-HiRess and MagicHalloween, by setting up the link into you config as per below instructions.  
2. Download the [merged pack](https://download.mc-packs.net/pack/f763c9554490a2f779abd6697a4b20668f7463db.zip) between Magic-HiRess, MagicHalloween and merge it with your server resource pack, if you have one. 
